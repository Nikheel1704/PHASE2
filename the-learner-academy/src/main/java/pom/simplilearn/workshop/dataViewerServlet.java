package pom.simplilearn.workshop;
...
public class dataViewerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql = "SELECT subject, studentName, teacherName FROM class";
		try {
			Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/leaener-academy?SSL=false","root","nikhil");
